...
import SiteShowcase from "@/assets/siteshowcase.svg";
  ...
  return (
    <header className="p-2 bg-[rgba(225,225,225,0.1)] backdrop-blur-3xl z-50 sticky top-0">
      <div className="md:container mx-auto flex justify-between items-center">
        <Link
          href="/"
          className="h-9 w-auto flex gap-2 justify-start mr-8 items-center p-1 rounded-md hover:bg-[rgba(225,225,225,0.05)]"
        >
          <Image
            src={SiteShowcase}
          ...
          />
          <span className="md:block hidden">SiteShowcase</span>
        </Link>
        <nav
          className={`lg:flex md:border-l md:border-slate-500 md:px-3 lg:flex-row flex-col flex-grow md:relative absolute md:w-auto w-full left-0 right-0 md:top-auto top-16 z-50 text-sm items-center ${isMenuOpen
        ...
        >
          ...
          <Link
            href="/working-flow"
            className="lg:inline-flex lg:w-auto px-3 py-2 rounded text-slate-700 dark:text-slate-300 items-center justify-center hover:bg-slate-100 dark:hover:bg-[rgba(225,225,225,0.1)] whitespace-nowrap"
          >
            How It Works
          </Link>
          <Link
        ...
        >
          <Button
            asChild
            className="bg-gradient-to-r from-[rgb(99,18,240)] to-[rgb(35,35,201)] !text-white rounded-full hover:backdrop-blur-lg"
          >
            <Link
              href="/auth/signup"
            >
